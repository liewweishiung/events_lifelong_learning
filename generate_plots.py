...
h = np.load('./store/results/habituation_counters_tasks-20_dr-0.3_topn-0.2_si-True_sic-10_7.npy')
g = sns.histplot(x=h, bins=20, log_scale=(False, 2))
g.axes.set(ylim=(0, 2600))
g.axes.set(yticks=[2, 8, 32, 128, 512, 2048])
g.set_xlabel("Values of habituation counters")
g.figure.savefig("./store/plots/distribution_habituation_counters_a.pdf", format="pdf",
                 bbox_inches="tight")
plt.close()

sns.set(font_scale=1.4)
h = np.load('./store/results/habituation_counters_tasks-20_dr-0.03_topn-0.02_si-True_sic-10000000.npy')
g = sns.histplot(x=h, bins=20, log_scale=(False, 2))
g.axes.set(ylim=(0, 2600))
g.axes.set(yticks=[2, 8, 32, 128, 512, 2048])
g.set_xlabel("Values of habituation counters")
g.figure.savefig("./store/plots/distribution_habituation_counters_b.pdf", format="pdf",
                 bbox_inches="tight")
plt.close()

sns.set(font_scale=1.4)
h = np.load('./store/results/habituation_counters_tasks-20_dr-0.3_topn-0.02_si-True_sic-10000000.npy')
g = sns.histplot(x=h, bins=20, log_scale=(False, 2))
g.axes.set(ylim=(0, 2600))
g.axes.set(yticks=[2, 8, 32, 128, 512, 2048])
g.set_xlabel("Values of habituation counters")
g.figure.savefig("./store/plots/distribution_habituation_counters_c.pdf", format="pdf",
                 bbox_inches="tight")
plt.close()

sns.set(font_scale=1.4)
h = np.load('./store/results/habituation_counters_tasks-20_dr-0.03_topn-0.2_si-True_sic-10_7.npy')
g = sns.histplot(x=h, bins=20, log_scale=(False, 2))
#g.axes.set_yscale('log')
g.axes.set(ylim=(0, 2600))
g.axes.set(yticks=[2, 8, 32, 128, 512, 2048])
g.set_xlabel("Values of habituation counters")
g.figure.savefig("./store/plots/distribution_habituation_counters_d.pdf", format="pdf",
                 bbox_inches="tight")
plt.close()
